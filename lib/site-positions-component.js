...
class SitePositionsComponent {
  constructor (props) {
    this.props = {
      ...
      displayedParticipantsCount: Infinity
    }
  ...
  render () {
    ...
    const siteIds = this.props.insideEditorSiteIds.concat(this.props.outsideEditorSiteIds).slice(0, this.props.displayedParticipantsCount)
