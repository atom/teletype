...
class EditorBinding {
  ...
  monkeyPatchEditorMethods (editor, editorProxy) {
    ...
    editor.getTitle = () => `${prefix}: ${path.basename(editorProxy.bufferProxy.delegate.bufferFile.getURI())}`
    ...
    buffer.getPath = () => `${prefix}:${this.editorProxy.bufferProxy.delegate.bufferFile.getURI()}`
