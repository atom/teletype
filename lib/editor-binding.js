...
class EditorBinding {
  ...
  setEditorProxy (editorProxy) {
    ...
    this.upperRightSitePositionsComponent = new SitePositionsComponent({
      displayedParticipantsCount: 3,
      position: 'upper-right',
      portal: this.portal,
      onSelectSiteId: this.editorProxy.follow.bind(this.editorProxy)
    })
    this.lowerRightSitePositionsComponent = new SitePositionsComponent({
      displayedParticipantsCount: 3,
