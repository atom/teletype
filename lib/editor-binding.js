...
class EditorBinding {
  ...
  monkeyPatchEditorMethods (editor, editorProxy) {
    ...
    editor.getTitle = () => `${prefix}: ${path.basename(getPathWithNativeSeparators(this.editorProxy.bufferProxy.uri + ''))}`
    ...
    buffer.getPath = () => `${prefix}:${getPathWithNativeSeparators(this.editorProxy.bufferProxy.uri + '')}`
