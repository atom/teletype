...
class GuestPortalBinding {
  constructor ({portal, workspace, notificationManager, didLeave, hostDidDisconnect, addStatusBarIndicatorForPortal, removeStatusBarIndicatorForPortal}) {
    this.portal = portal
  ...
  initialize () {
    ...
    this.addStatusBarIndicatorForPortal(this.portal, {isHost: false})
