...
class HostPortalBinding {
  constructor ({portal, workspace, clipboard, notificationManager, addStatusBarIndicatorForPortal, removeStatusBarIndicatorForPortal}) {
    this.portal = portal
    this.workspace = workspace
    this.clipboard = clipboard
    this.notificationManager = notificationManager
    this.addStatusBarIndicatorForPortal = addStatusBarIndicatorForPortal
    this.removeStatusBarIndicatorForPortal = removeStatusBarIndicatorForPortal
  ...
  initialize () {
    ...
    this.addStatusBarIndicatorForPortal(this.portal, {isHost: true})
  ...
  dispose () {
    ...
    this.removeStatusBarIndicatorForPortal(this.portal)
  ...
  async didChangeActiveTextEditor (editor) {
    ...
    if (!editorBinding) {
      ...
      editorBinding = new EditorBinding(editor)
