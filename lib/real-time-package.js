...
class RealTimePackage {
  ...
  async sharePortal () {
    ...
    const message = `You can now invite people to collaborate with you using your portal ID below. It's already on your clipboard. 👌<br/><br/>${portal.id}`
    this.workspace.notificationManager.addInfo(message, {dismissable: true})
  }
