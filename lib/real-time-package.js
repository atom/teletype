...
class RealTimePackage {
  ...
  async shareEditor (editor) {
    ...
    new BufferBinding(buffer, sharedBuffer)
    ...
    new EditorBinding(editor, sharedEditor)

    this.clipboard.write(sharedEditor.id)
  }
  ...
  async joinEditor () {
    ...
    new BufferBinding(editor.getBuffer(), sharedBuffer)
