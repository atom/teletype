...
class HostPortalBindingComponent {
  ...
  copyPortalIdToClipboard () {
    ...
    if (this.resetCopiedConfirmationTimeoutId) {
      clearTimeout(this.resetCopiedConfirmationTimeoutId)
    }

    this.props.showCopiedConfirmation = true
    etch.update(this)
    this.resetCopiedConfirmationTimeoutId = setTimeout(() => {
      this.props.showCopiedConfirmation = false
      etch.update(this)
      this.resetCopiedConfirmationTimeoutId = null
    }, 2000)
  }
